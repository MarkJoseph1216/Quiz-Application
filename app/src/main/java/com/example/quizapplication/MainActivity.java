...
public class MainActivity extends AppCompatActivity {
    ...
    ImageButton btnSettings, btnAboutUs, btnPlay, btnLeaderBoards;
    TextInputEditText edtRegKey;
    Dialog dialogExit;
    Button btnCancel, btnExit, btnOkay, btnScanRegister, btnCancelZone, btnOkayZone;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnLeaderBoards = (ImageButton) findViewById(R.id.btnLeaderBoards);
        ...
        btnAboutUs.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                methods.intentMethod(AboutUsActivity.class);
            }
        });
        ...
        btnLeaderBoards.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                methods.intentMethod(LeaderBoardsActivity.class);
            }
        });
    }
